...
void APyroCharacter::NotifyControllerChanged()
{
...
void APyroCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &APyroCharacter::Move);
...
void APyroCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
